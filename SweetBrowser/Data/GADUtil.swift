...
extension GADBaseModel.GADOpenModel: GADFullScreenContentDelegate {
    public override func loadAd(completion: ((_ result: Bool, _ error: String) -> Void)?) {
        loadedHandler = completion
        loadedDate = nil
...
extension GADLoadModel {
    ...
    func prepareLoadAd(array: [GADModel], callback: ((_ isSuccess: Bool) -> Void)? , in store: Store) {
...
//        }
        ...
        case .open:
            ad = GADBaseModel.GADOpenModel(model: array[preloadIndex])
        }
